...
namespace DownBelow.Spells {
	...
	public class SpellData_Stats : SpellData {
		...
		[FoldoutGroup("STATS Spell Datas")]
		public ApplyType ApplyType = ApplyType.Normal;
	}

	public class SpellData_StealStats : SpellData_Stats {
	...
	public class Spell_Stats : Spell<SpellData_Stats> {
		...
		public override async Task DoSpellBehavior() {
			...
			else if (LocalData is SpellData_StealStats steal) {
				RefEntity.ApplyStat(steal.Statistic, Result.DamagesDealt.Values.Sum());
			}
		}
	}
}
