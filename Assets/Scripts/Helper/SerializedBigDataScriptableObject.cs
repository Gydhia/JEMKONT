...
public class SerializedBigDataScriptableObject<T> : ScriptableObject
    where T : class, new()
{
    [ShowInInspector]
    ...
    public T LazyLoadedData { get { return this.Data; } }
    ...
    public virtual void Save(T obj)
    {
        ...
        byte[] bytes = Sirenix.Serialization.SerializationUtility.SerializeValue(data, DataFormat.Binary, out this.unityObjectReferences);
